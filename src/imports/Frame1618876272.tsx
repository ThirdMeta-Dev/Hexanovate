import svgPaths from "./svg-xvssryphbj";
...
function Frame26() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute backdrop-blur-[50px] bg-[rgba(27,97,219,0.15)] content-stretch flex gap-[68px] h-[426px] items-start left-[calc(50%-1px)] p-[48px] rounded-[30px] top-[calc(50%-0.5px)] w-[1104px]">
