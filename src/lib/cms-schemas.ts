...
export const SECTION_SCHEMAS: Record<string, SectionSchema> = {
  ...
  FmcgSection: {
    ...
    fields: [
      ...
      { key: "galleryImg1", label: "Gallery Image 1", type: "image" },
      { key: "galleryImg2", label: "Gallery Image 2", type: "image" },
      { key: "galleryImg3", label: "Gallery Image 3", type: "image" },
      { key: "galleryImg4", label: "Gallery Image 4", type: "image" },
      { key: "galleryImg5", label: "Gallery Image 5", type: "image" },
      { key: "galleryImg6", label: "Gallery Image 6", type: "image" },
    ],
    isCarousel: true,
    carouselLabel: "FMCG Client Portfolios",
    defaultItems: [
      { clientName: "Foodrite", metric1Value: "156+", metric1Label: "Products Launched Successfully", metric2Value: "87%", metric2Label: "Market Share Growth Rate" },
      { clientName: "NutriBlend", metric1Value: "200+", metric1Label: "SKUs Distributed", metric2Value: "92%", metric2Label: "Retailer Satisfaction Rate" },
      { clientName: "FreshHarvest", metric1Value: "3x", metric1Label: "Revenue Growth in 12 Months", metric2Value: "45+", metric2Label: "New Markets Entered" },
      { clientName: "PureVitality", metric1Value: "180+", metric1Label: "Outlets Onboarded", metric2Value: "68%", metric2Label: "Repeat Purchase Rate" },
      { clientName: "GoldenGrain", metric1Value: "50+", metric1Label: "Cities Covered", metric2Value: "4.2x", metric2Label: "ROI on Trade Spends" },
    ],
    itemFields: [
  ...
  EducationSection: {
    ...
    defaultItems: [
      ...
      { num: "04", title: "native.academy – 4.2x Engagement Growth", desc: "Built a cohesive digital learning ecosystem for native.academy, achieving 4.2x engagement growth and 60K new enrollments through a refined student acquisition funnel.", imageUrl: "" },
  ...
  FaqSection: {
    ...
    defaultItems: [
      { question: "Is Hexanovate an agency?", answer: "No. Hexanovate is a connected growth ecosystem. Think of us as the infrastructure your business needs to scale. We house specialized brands like ThirdMeta (B2B), The Native Unit (FMCG), and native.academy (Education), all working under one unified vision." },
